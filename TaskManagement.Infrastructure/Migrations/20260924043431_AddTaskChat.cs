...
{
    /// <inheritdoc />
    public partial class AddTaskChat : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatSessions_TaskItems_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatSessions_TaskId",
                table: "ChatSessions",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatSessions_TaskId_UserId_IsActive",
                table: "ChatSessions",
                columns: new[] { "TaskId", "UserId", "IsActive" });
