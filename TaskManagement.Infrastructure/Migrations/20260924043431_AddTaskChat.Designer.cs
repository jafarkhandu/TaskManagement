...
namespace TaskManagement.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260924043431_AddTaskChat")]
    partial class AddTaskChat
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.ChatSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TaskId", "UserId", "IsActive");
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.ChatMessage", b =>
                {
                    b.HasOne("TaskManagement.Domain.Entities.ChatSession", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.Notification", b =>
                {
                    b.HasOne("TaskManagement.Domain.Entities.TaskAssignment", null)
                        .WithMany()
